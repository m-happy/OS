...
{
  "$end", "error", "$undefined", "HMOVE", "SPACE", "PAWNMOVE", "CAPTURE",
  "MOVE", "ROW", "COLUMN", "NEWLINE", "$accept", "move", "turn", YY_NULLPTR
};
#endif
...
{
       1,    10,    11,     6,     5,     2,    13,    14,     7,     8,
       9,    15,    16,     0,     0,    18,    17,    19,     0,    20,
      21,    23,    24,    12,     0,     0,     0,     0,     0,     0,
       0,    22
};
...
{
       0,     3,     8,    12,    13,     8,     9,     0,     4,     9,
       6,     7,    13,     6,     7,     8,     8,    10,     8,     8,
       9,     9,    12,     9,     9
};
...
#line 54 "p1.y" /* yacc.c:1646  */
    { make_move(0, (yyvsp[-4].a), (yyvsp[-3].a), (yyvsp[-1].a), (yyvsp[0].a));}
...
#line 56 "p1.y" /* yacc.c:1646  */
    { make_move((yyvsp[-5].a), (yyvsp[-4].a), (yyvsp[-3].a), (yyvsp[-1].a), (yyvsp[0].a));}
